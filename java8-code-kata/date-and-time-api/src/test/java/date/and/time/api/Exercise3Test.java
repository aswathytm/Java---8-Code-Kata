...
public class Exercise3Test {
    ...
    public void localDateTimeParse() {
         ...
         */
        LocalDateTime localDateTime = LocalDateTime.parse("2015-06-20 23:07:30",DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"));
...
//        LocalDateTime localDateTime1 = ld.atTime(LocalTime.from(LocalDateTime.of(ld, lt)));
//        LocalDateTime localDateTime2 = lt.atDate(LocalDate.from(LocalDateTime.of(ld, lt)));
